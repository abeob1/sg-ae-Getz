<%@ page language="C#" autoeventwireup="true" inherits="CompletedJobVsClassificationReport_v2, App_Web_zyiaz0dm" %>
...
<body>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="8">
    <tr>
      <td class="PageHeader">Completed vs. Classification Job</td>
    </tr>
    <tr>
      <td>     
    ...
    <table width="100%"  border="0" cellpadding="2" cellspacing="0" class="FormTable">
            ...
            <tr>
                ...
                <asp:DropDownList ID="ddl_dchannel" Visible=false runat="server" CssClass="FormElement"></asp:DropDownList>
                <asp:DropDownList ID="ddl_plant" Visible=false runat="server" CssClass="FormElement"></asp:DropDownList>                
