...
<%
	If Request.QueryString("DELETE") = "TRUE" Then
		...
		db.Execute "DELETE FROM vw_MasterEquipment WHERE equipment_id = '" & Request.QueryString("id") & "'"
		db.Close
		Set db = Nothing
		
		Response.Redirect("swordfish_master_equipments.asp")
	End If
%>
<%
Dim rs_result
...
rs_result.Source = "SELECT * FROM dbo.vw_MasterEquipment"
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="8">
    ...
    <tr>
      <td>        <table width="100%"  border="0" cellpadding="1" cellspacing="0" class="FormTable">
          ...
          <td colspan="5" class="DataGridToolbar"><table width="100%"  border="0" cellspacing="2" cellpadding="1">
            <tr>
              <td><select name="master_switch" class="FormElement" id="master_switch" onChange="document.URL = document.forms[0].master_switch[document.forms[0].master_switch.selectedIndex].value;">
                ...
                <option value="swordfish_master_equipments.asp" selected>Equipments</option>
        ...
        <td class="DataGridHeader">Serial No.</td>
        <td class="DataGridHeader">Object Type</td>
...
%>
        <tr>
            <td class="DataGridRow"><%=(rs_result.Fields.Item("equipment_id").Value)%></td>
            <td class="DataGridRow"><%=(rs_result.Fields.Item("equipment_desc").Value)%></td>
        <td class="DataGridRow"><%=(rs_result.Fields.Item("equipment_snr").Value)%></td>
            <td class="DataGridRow"><%=(rs_result.Fields.Item("equipment_obj").Value)%></td>
