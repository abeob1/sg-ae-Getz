    ...
    public class OpNotificationManager : SwordfishManagerBase, IManager, IDisposable
    {
        ...
        public DataTable GetCompletedJobVsJobClassification(int Year, string dchannel, string plant)
        {
            ...
            if (this.TryConnection())
            {
                ...
                parameters.Add(new DatabaseParameter(this.DataStructrure.StoredProcedures.GetCompletedJobVsJobClassification.Param_DChannel.ActualFieldName, dchannel));
                parameters.Add(new DatabaseParameter(this.DataStructrure.StoredProcedures.GetCompletedJobVsJobClassification.Param_Plant.ActualFieldName, plant));
        ...
        public DataTable GetCompletedVsPendingJob(int Year, int Month, string dchannel, string plant)
        {
            ...
            if (this.TryConnection())
            {
                ...
                parameters.Add(new DatabaseParameter(this.DataStructrure.StoredProcedures.GetCompletedVsPendingJob.Param_DChannel.ActualFieldName, dchannel));
                parameters.Add(new DatabaseParameter(this.DataStructrure.StoredProcedures.GetCompletedVsPendingJob.Param_Plant.ActualFieldName, plant));
