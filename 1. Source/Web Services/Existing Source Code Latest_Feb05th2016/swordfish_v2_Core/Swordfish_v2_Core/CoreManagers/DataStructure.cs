namespace Swordfish_v2_Core.CoreManagers
{
    ...
    internal sealed class DataStructure
    {
        ...
        public class StoredProceduresCollection
        {
            ...
            public DataStructure.StoredProceduresGetQuotationDetailByEngineerForUnfinishJob GetQuotationDetailByEngineerForUnfinishJob = new DataStructure.StoredProceduresGetQuotationDetailByEngineerForUnfinishJob("sp_GetQuotationDetailByEngineerForUnFinishJob");
            public DataStructure.StoredProceduresGetQuotationHeaderByEngineerForUnfinishJob GetQuotationHeaderByEngineerForUnfinishJob = new DataStructure.StoredProceduresGetQuotationHeaderByEngineerForUnfinishJob("sp_GetQuotationHeaderByEngineerForUnFinishJob");
            ...
            public DataStructure.StoredProceduresUploadDataFromLocal UploadDataFromLocal = new DataStructure.StoredProceduresUploadDataFromLocal("sp_UploadDataFromLocal");
            public DataStructure.StoredProceduresCloseConnections closeConnections = new DataStructure.StoredProceduresCloseConnections("AE_SP001_CloseConnection");
        }
        ...
        {
            public DataStructure.TableBase.DataColumn Causes;
            public DataStructure.TableBase.DataColumn Damages;
            public DataStructure.TableBase.DataColumn notification_no;
            public DataStructure.TableBase.DataColumn notification_subject;
            public DataStructure.TableBase.DataColumn Param_EquipmentID;
            public DataStructure.TableBase.DataColumn Parts;
            ...
            public StoredProceduresGetNotificationHistoryByEquipment(string PrivateName) : base(PrivateName)
            {
                ...
                this.notification_subject = new DataStructure.TableBase.DataColumn("notification_subject");
                this.notification_no = new DataStructure.TableBase.DataColumn("notification_no");
                this.Damages = new DataStructure.TableBase.DataColumn("Damages");
                this.Causes = new DataStructure.TableBase.DataColumn("Causes");
                this.Parts = new DataStructure.TableBase.DataColumn("Parts");
            }
        }

        public class StoredProceduresGetQuotationDetailByEngineerForUnfinishJob : DataStructure.TableBase
        {
            public DataStructure.TableBase.DataColumn Param_EngineerID;

            public StoredProceduresGetQuotationDetailByEngineerForUnfinishJob(string PrivateName) : base(PrivateName)
            {
                this.Param_EngineerID = new DataStructure.TableBase.DataColumn("@EngineerID");
            }
        }

        public class StoredProceduresGetQuotationHeaderByEngineerForUnfinishJob : DataStructure.TableBase
        {
            public DataStructure.TableBase.DataColumn Param_EngineerID;

            public StoredProceduresGetQuotationHeaderByEngineerForUnfinishJob(string PrivateName) : base(PrivateName)
            {
                this.Param_EngineerID = new DataStructure.TableBase.DataColumn("@EngineerID");
            }
        }
        ...
        public class StoredProceduresUploadDataFromLocal : DataStructure.TableBase
        {
            public DataStructure.TableBase.DataColumn Param_Error;
            public DataStructure.TableBase.DataColumn Param_Query;

            public StoredProceduresUploadDataFromLocal(string PrivateName) : base(PrivateName)
            {
                this.Param_Error = new DataStructure.TableBase.DataColumn("@Error");
                this.Param_Query = new DataStructure.TableBase.DataColumn("@Query");
            }
        }

        public class StoredProceduresCloseConnections : DataStructure.TableBase
        {
            public DataStructure.TableBase.DataColumn Param_Error;
            public DataStructure.TableBase.DataColumn Param_Query;

            public StoredProceduresCloseConnections(string PrivateName)
                : base(PrivateName)
            {
                this.Param_Error = new DataStructure.TableBase.DataColumn("@Error");
                this.Param_Query = new DataStructure.TableBase.DataColumn("@Query");
        ...
        {
            public TableActionLogSQL ActionLogSQL = new TableActionLogSQL("action_log_sql");
            ...
            public TableOpMessage OpMessage = new TableOpMessage("op_message");
            ...
            public class TableActionLogSQL : DataStructureBase.Table
            {
                public DataStructure.TableBase.DataColumn SQLQuery;

                public TableActionLogSQL(string PrivateName) : base("", PrivateName)
                {
                    this.SQLQuery = new DataStructure.TableBase.DataColumn("sql_query");
                }
            ...
            public class TableOpMessage : DataStructureBase.Table
            {
                public DataStructure.TableBase.DataColumn EngineerID;
                public DataStructure.TableBase.DataColumn InternalID;
                public DataStructure.TableBase.DataColumn IsRead;
                public DataStructure.TableBase.DataColumn MessageArrivalDate;
                public DataStructure.TableBase.DataColumn MessageDate;
                public DataStructure.TableBase.DataColumn MessageText;
                public DataStructure.TableBase.DataColumn SenderID;

                public TableOpMessage(string PrivateName) : base("", PrivateName)
                {
                    this.InternalID = new DataStructure.TableBase.DataColumn("internal_id");
                    this.SenderID = new DataStructure.TableBase.DataColumn("sender_id");
                    this.EngineerID = new DataStructure.TableBase.DataColumn("engineer_id");
                    this.MessageText = new DataStructure.TableBase.DataColumn("msg_text");
                    this.MessageDate = new DataStructure.TableBase.DataColumn("msg_date");
                    this.MessageArrivalDate = new DataStructure.TableBase.DataColumn("msg_arrival_date");
                    this.IsRead = new DataStructure.TableBase.DataColumn("msg_isread");
                }
            ...
            public class TableOpNotification : DataStructure.TableBase
            {
                ...
                public DataStructure.TableBase.DataColumn Closed;
                ...
                public TableOpNotification(string ActualDBName) : base(ActualDBName)
                {
                    ...
                    this.Closed = new DataStructure.TableBase.DataColumn("notification_closed");
                }
            }
        ...
        {
            public ViewOpMessage OpMessage = new ViewOpMessage("vw_op_message");

            public class ViewOpMessage : DataStructure.TablesCollection.TableOpMessage
            {
                public DataStructure.TableBase.DataColumn EngineerName;

                public ViewOpMessage(string PrivateName) : base(PrivateName)
                {
                    this.EngineerName = new DataStructure.TableBase.DataColumn("engineer_name");
                }
            }
        }
    }
