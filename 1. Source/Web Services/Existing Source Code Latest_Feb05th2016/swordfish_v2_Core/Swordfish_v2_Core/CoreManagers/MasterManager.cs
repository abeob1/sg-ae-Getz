namespace Swordfish_v2_Core.CoreManagers
{
    ...
    public class MasterManager : SwordfishManagerBase, IManager, IDisposable
    {
        ...
        public MasterManager(SessionConfig PrivateSessionConfig)
            : base(PrivateSessionConfig)
        {
        ...
        public MasterQuickNotesCollection GetAllActiveQuickNotesInColl()
        {
            MasterQuickNotesCollection notess = null;
            if (this.TryConnection())
            {
                DatabaseParameters parameters = new DatabaseParameters();
                parameters.Add(new DatabaseParameter(this.DataStructrure.Tables.MasterQuickNotes.active.ActualFieldName, "1"));
                ...
                if (table != null)
                {
                    notess = new MasterQuickNotesCollection();
                    foreach (DataRow row in table.Rows)
                    {
                        MasterQuickNotes notes = new MasterQuickNotes(row[this.DataStructrure.Tables.MasterQuickNotes.InternalID.ActualFieldName].ToString())
                        {
                            description = row[this.DataStructrure.Tables.MasterQuickNotes.Description.ActualFieldName].ToString(),
                            lang = row[this.DataStructrure.Tables.MasterQuickNotes.Language.ActualFieldName].ToString(),
                            active = row[this.DataStructrure.Tables.MasterQuickNotes.active.ActualFieldName].ToString()
                        };
                        notess.Add(notes);
                    }
                    this.DisposeObjects();
        ...
        public MasterCauseCollection GetMasterCauseInColl(DateTime dtCreated)
        {
            MasterCauseCollection causes = null;
            string str = dtCreated.Year.ToString() + "-" + dtCreated.Month.ToString() + "-" + dtCreated.Day.ToString() + " 00:00:00";
            if (this.TryConnection())
            {
                DatabaseParameters parameters = new DatabaseParameters();
                ...
                if (table != null)
                {
                    causes = new MasterCauseCollection();
                    foreach (DataRow row in table.Rows)
                    {
                        MasterCause cause = new MasterCause(row[this.DataStructrure.Tables.MasterCause.CauseCode.ActualFieldName].ToString(), row[this.DataStructrure.Tables.MasterCause.CauseDescription.ActualFieldName].ToString(), row[this.DataStructrure.Tables.MasterCause.CauseGroup.ActualFieldName].ToString());
                        causes.Add(cause);
                    }
                    this.DisposeObjects();
                    return causes;
        ...
        public MasterCheckListTypeCollection GetMasterCheckListTypedtInColl()
        {
            MasterCheckListTypeCollection types = null;
            if (this.TryConnection())
            {
                DatabaseParameters parameters = new DatabaseParameters();
                base.CurSQLFactory.SelectCommand(parameters, this.DataStructrure.Tables.MasterCheckListType.ActualTableName);
                ...
                if (table != null)
                {
                    types = new MasterCheckListTypeCollection();
                    foreach (DataRow row in table.Rows)
                    {
                        MasterCheckListType type = new MasterCheckListType(row[this.DataStructrure.Tables.MasterCheckListType.InternalID.ActualFieldName].ToString())
                        {
                            type_name = row[this.DataStructrure.Tables.MasterCheckListType.TypeName.ActualFieldName].ToString()
                        };
                        types.Add(type);
                    }
                    DisposeObjects();
                ...
                base.error_occured = true;
                base.ErrMsg = "[MasterManager] : GetMasterCheckListTypedtInColl : " + base.CurDBEngine.ErrorMessage;
                DisposeObjects();
                return types;
            }
            base.error_occured = true;
            base.ErrMsg = "[MasterManager] : GetMasterCheckListTypedtInColl : " + base.ErrMsg;
            DisposeObjects();
            return types;
        }

        public MasterCheckListTypeCollection GetMasterCheckListTypedtInColl(DateTime dtCreated)
        {
            MasterCheckListTypeCollection types = null;
            string str = dtCreated.Year.ToString() + "-" + dtCreated.Month.ToString() + "-" + dtCreated.Day.ToString() + " 00:00:00";
            if (this.TryConnection())
        ...
        public MasterDamageCollection GetMasterDamageInColl(DateTime dtCreated)
        {
            MasterDamageCollection damages = null;
            string str = dtCreated.Year.ToString() + "-" + dtCreated.Month.ToString() + "-" + dtCreated.Day.ToString() + " 00:00:00";
            if (this.TryConnection())
            {
                DatabaseParameters parameters = new DatabaseParameters();
                ...
                if (table != null)
                {
                    damages = new MasterDamageCollection();
                    foreach (DataRow row in table.Rows)
                    {
                        MasterDamage damage = new MasterDamage(row[this.DataStructrure.Tables.MasterDamage.DamageCode.ActualFieldName].ToString(), row[this.DataStructrure.Tables.MasterDamage.DamageDescription.ActualFieldName].ToString(), row[this.DataStructrure.Tables.MasterDamage.DamageGroup.ActualFieldName].ToString());
                        damages.Add(damage);
                    }
                    this.DisposeObjects();
                    return damages;
        ...
        {
            MasterLookUpCollection ups = null;
            if (this.TryConnection())
            {
                DatabaseParameters parameters = new DatabaseParameters();
                base.CurSQLFactory.SelectCommand(parameters, this.DataStructrure.Tables.MasterLookUp.ActualTableName);
                base.CurSQLFactory.SQL = base.CurSQLFactory.SQL + " WHERE MASTER_DESC LIKE '%" + sItemName + "%'";
                DataTable table = base.CurDBEngine.SelectQuery(base.CurSQLFactory.SQL);
                if (table != null)
                {
                    ups = new MasterLookUpCollection();
                    foreach (DataRow row in table.Rows)
                    {
                        MasterLookUp up = new MasterLookUp(row[this.DataStructrure.Tables.MasterLookUp.MasterID.ActualFieldName].ToString())
                        {
                            master_desc = row[this.DataStructrure.Tables.MasterLookUp.MasterDescription.ActualFieldName].ToString(),
                            master_type = row[this.DataStructrure.Tables.MasterLookUp.MasterType.ActualFieldName].ToString(),
                        };
                        ups.Add(up);
                    }
                    return ups;
                ...
                base.error_occured = true;
                base.ErrMsg = "[MasterManager] : GetItem : " + base.CurDBEngine.ErrorMessage;
                return ups;
            }
            base.error_occured = true;
            base.ErrMsg = "[MasterManager] : GetItem : " + base.ErrMsg;
            return ups;
        }

        public MasterLookUpCollection GetMasterLookupInColl(DateTime dtCreated)
        {
            MasterLookUpCollection ups = null;
            try
            {
                ...
                if (this.TryConnection())
                {
                    ...
                    base.CurSQLFactory.SQL = base.CurSQLFactory.SQL + " WHERE dt_created >= CAST('" + str + "' AS DATETIME)";
                    DataTable table = base.CurDBEngine.SelectQuery(base.CurSQLFactory.SQL);
                    oLog.WriteToDebugLogFile("Master DB Query :" + base.CurSQLFactory.SQL, "GetMasterLookupInColl");
                    oLog.WriteToDebugLogFile("Master DB Date :" + dtCreated, "GetMasterLookupInColl");
                    if (table != null)
                    {
                        ups = new MasterLookUpCollection();
                        foreach (DataRow row in table.Rows)
                        {
                            MasterLookUp up = new MasterLookUp(row[this.DataStructrure.Tables.MasterLookUp.MasterID.ActualFieldName].ToString())
                            {
                                master_desc = row[this.DataStructrure.Tables.MasterLookUp.MasterDescription.ActualFieldName].ToString(),
                                master_type = row[this.DataStructrure.Tables.MasterLookUp.MasterType.ActualFieldName].ToString(),
                                dt_created = row[this.DataStructrure.Tables.MasterLookUp.dtCreated.ActualFieldName].ToString()
                            };
                            ups.Add(up);
                        }
                        this.DisposeObjects();
                    ...
                    base.error_occured = true;
                    base.ErrMsg = "[MasterManager] : GetMasterLookupInColl : " + base.CurDBEngine.ErrorMessage;
                    oLog.WriteToDebugLogFile("Master Lookup DB error" + base.ErrMsg, "GetMasterLookupInColl");
                    this.DisposeObjects();
                    return ups;
                }
                base.error_occured = true;
                base.ErrMsg = "[MasterManager] : GetMasterLookupInColl : " + base.ErrMsg;
                oLog.WriteToDebugLogFile("Calling Again Dispose", "GetMasterLookupInColl");
                this.DisposeObjects();
            }
            catch (Exception ex)
            {
                oLog.WriteToDebugLogFile("Completed with Error : " + ex.Message.ToString(), "GetMasterLookupInColl");
                this.DisposeObjects();
            }
            return ups;
        }
        ...
        //            DatabaseParameters parameters = new DatabaseParameters();
        //            base.CurSQLFactory.ExecuteStoredProcedure(this.DataStructrure.StoredProcedures.closeConnections.ActualTableName, parameters);
        //            table = base.CurDBEngine.SelectQuery(base.CurSQLFactory.SQL);
        //            if (table == null)
        //            {
        //                base.error_occured = true;
        //                base.ErrMsg = "[MasterManager] : CloseConnections : " + base.CurDBEngine.ErrorMessage;
        //            }
        //            return table;
        //        }
        //        base.error_occured = true;
        //        base.ErrMsg = "[MasterManager] : CloseConnections : " + base.ErrMsg;
        //    }
        //    catch (Exception ex)
        //    {
