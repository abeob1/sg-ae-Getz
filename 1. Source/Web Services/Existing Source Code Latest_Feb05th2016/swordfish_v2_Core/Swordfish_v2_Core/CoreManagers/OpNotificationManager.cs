namespace Swordfish_v2_Core.CoreManagers
{
    ...
    public class OpNotificationManager : SwordfishManagerBase, IManager, IDisposable
    {
        ...
        public OpNotificationManager(SessionConfig PrivateSessionConfig)
        ...
        public bool UpdateNotificationByInternalID(OpNotificationObj CurOpNotification)
        {
            ...
            oLog.WriteToDebugLogFile("Starting Function", "UpdateNotificationByInternalID");
            bool flag = false;
            if (this.TryConnection())
            {
                DatabaseParameters keys = new DatabaseParameters();
                ...
                keys.Add(new DatabaseParameter(this.DataStructrure.Tables.OpNotification.InternalID.ActualFieldName, CurOpNotification.InternalID));
                keys.Add(new DatabaseParameter(this.DataStructrure.Tables.OpNotification.Closed.ActualFieldName, "0"));
                ...
                oLog.WriteToDebugLogFile("Before Dispose", "UpdateNotificationByInternalID");
                DisposeObjects();
                oLog.WriteToDebugLogFile("After Dispose :" + flag, "UpdateNotificationByInternalID");
                return flag;
            }
            oLog.WriteToDebugLogFile("After dispose , again dispose", "UpdateNotificationByInternalID");
            base.error_occured = true;
            base.ErrMsg = base.ErrMsg + "[OpNotificationManager] : UpdateOpNotificationByInternalID : " + base.ErrMsg;
            DisposeObjects();
            oLog.WriteToDebugLogFile("Ending Function", "UpdateNotificationByInternalID");
            return flag;
        }
